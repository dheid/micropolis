...
/**
 * The listener interface for receiving miscellaneous events that occur in the Micropolis city. Use
 * the Micropolis class's addListener interface to register an object that implements this
 * interface.
 */
public interface CityListener {
  ...
  /**
   * Fired whenever the "census" is taken, and the various historical counters have been updated.
