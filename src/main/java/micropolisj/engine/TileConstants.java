...
/**
 * Contains symbolic names of certain tile values, and helper functions to test tile attributes.
...
public class TileConstants {
  ...
  /**
   * Checks whether the tile is a road that will automatically change to connect to neighboring
   * roads.
   */
  ...
  /**
   * Checks whether the tile is defined with the "industrial-zone" attribute. Note: the old version
   * of this function erroneously included the coal power plant smoke as an industrial zone.
   */
  ...
  /**
   * Determine the population level of a Residential zone tile. Note: the input tile MUST be a
   * full-size res zone, it cannot be an empty zone.
   *
